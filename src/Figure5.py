...
def set_ax(ax, white_c):
    ...
    ax.set_xticks(
        np.arange(8)[1::2],
        [50, 100, 200, 400, 600, 800, 900, 1000][1::2],
        fontsize=30,
        color=white_c,
    )
    ax.set_yticks(
...
ax1.errorbar(
    ...
    ls="dotted",
    label="NP kNN CEBRA joint (330ms)",
    color=c,
    alpha=1,
    markersize=20,
    linewidth=8,
...
ax1.errorbar(
    np.arange(8),
    n_mean_err(scene_np_knn_baseline_330)[0] * 100,
    n_mean_err(scene_np_knn_baseline_330)[1] * 100,
    ls="--",
    label="NP kNN baseline (330ms)",
    color="k",
    alpha=0.7,
...
ax1.errorbar(
    np.arange(8),
    n_mean_err(scene_np_bayes_baseline_330)[0] * 100,
    n_mean_err(scene_np_bayes_baseline_330)[1] * 100,
    ls="--",
    label="NP Bayes baseline (330ms)",
    color="k",
    alpha=0.3,
...
ax1.errorbar(
    np.arange(8),
    n_mean_err(scene_np_cebra_knn_330)[0] * 100,
    n_mean_err(scene_np_cebra_knn_330)[1] * 100,
    label="NP kNN CEBRA (330ms)",
    color=c,
    alpha=1,
    markersize=20,
...
ax1.errorbar(
    np.arange(8),
    n_mean_err_joint(scene_np_joint_cebra_knn_330, "np")[0] * 100,
...
plt.xticks(
    np.arange(1, 8, 2),
    [10, 30, 50, 100, 200, 400, 600, 800][1::2],
    fontsize=30,
    color="k",
)
