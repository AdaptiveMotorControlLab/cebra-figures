...
metrics = ['batch_size', 'conditional', 'delta', 'device', 'learning_rate', 'loss_distance', 'model', 'num_hidden_units', 'num_output', 'num_steps', 'save_emissions', 'save_frequency', 'share_model', 'temperature', 'time_offset', 'tqdm', 'train_ratio', 'valid_frequency', 'valid_ratio', 'variant', 'repeat', 'steps']
full_metrics = metrics + ["data_mode"]
results = pd.read_csv('../data/Figure4SupplementMultisession_rat.csv').applymap(recover_python_datatypes)
